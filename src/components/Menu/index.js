        ...
        return (
            <div className={nav}>
                ...
                <ul className="display-flex  list-none"> 
                    <li className="padding0-10 "><a className="no-deco asbestos" href="/#">Developpement</a></li>
                    <li className="padding0-10 "><a className="no-deco asbestos" href="/#">Consulting</a></li>
                </ul>
            </div>
        )
    }
